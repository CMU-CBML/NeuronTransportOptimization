...
private:
    ...
    void BasisFunctionCoarseSpace(double u, double v, int nen, const vector<array<double, phy_dim>> &pt, const vector<array<double, bzpt_num>> &cmat, vector<double> &Nx, vector<array<double, dim>> &dNdx, double &detJ);
    ...
    void BuildLinearSystemProcessUnitMatrix(const vector<Vertex2D> &cpts, const vector<double> val_bc[state_num], const vector<double> val_ini[state_num]);
    void BuildLinearSystemProcessAsubmat(const vector<Vertex2D> &cpts, const vector<double> val_bc[state_num], const vector<double> val_ini[state_num], const bool flag_glb);
    void BuildLinearSystemProcess(const UserSetting2D *user, const vector<Vertex2D> &cpts, const vector<double> val_bc[state_num], const vector<double> val_ini[state_num], const bool flag_glb);
    ...
    void ElementFormMatrixA11(bool flag_glb, const vector<int> &IEN, vector<vector<double>> EM, vector<vector<double>> EK, vector<vector<double>> EConv, vector<vector<double>> EPx, vector<vector<double>> EPy, vector<vector<double>> EStable);
    void ElementFormMatrixA12(bool flag_glb, const vector<int> &IEN, vector<vector<double>> EM, vector<vector<double>> EK, vector<vector<double>> EConv, vector<vector<double>> EPx, vector<vector<double>> EPy, vector<vector<double>> EStable);
    void ElementFormMatrixA13(bool flag_glb, const vector<int> &IEN, vector<vector<double>> EM, vector<vector<double>> EK, vector<vector<double>> EConv, vector<vector<double>> EPx, vector<vector<double>> EPy, vector<vector<double>> EStable);
    void ElementFormMatrixA21(bool flag_glb, const vector<int> &IEN, vector<vector<double>> EM, vector<vector<double>> EK, vector<vector<double>> EConv, vector<vector<double>> EPx, vector<vector<double>> EPy, vector<vector<double>> EStable);
    void ElementFormMatrixA22(bool flag_glb, const vector<int> &IEN, vector<vector<double>> EM, vector<vector<double>> EK, vector<vector<double>> EConv, vector<vector<double>> EPx, vector<vector<double>> EPy, vector<vector<double>> EStable);
    void ElementFormMatrixA23(bool flag_glb, const vector<int> &IEN, vector<vector<double>> EM, vector<vector<double>> EK, vector<vector<double>> EConv, vector<vector<double>> EPx, vector<vector<double>> EPy, vector<vector<double>> EStable);
    void ElementFormMatrixA31(bool flag_glb, const vector<int> &IEN, vector<vector<double>> EM, vector<vector<double>> EK, vector<vector<double>> EConv, vector<vector<double>> EPx, vector<vector<double>> EPy, vector<vector<double>> EStable);
    void ElementFormMatrixA32(bool flag_glb, const vector<int> &IEN, vector<vector<double>> EM, vector<vector<double>> EK, vector<vector<double>> EConv, vector<vector<double>> EPx, vector<vector<double>> EPy, vector<vector<double>> EStable);
    void ElementFormMatrixA33(bool flag_glb, const vector<int> &IEN, vector<vector<double>> EM, vector<vector<double>> EK, vector<vector<double>> EConv, vector<vector<double>> EPx, vector<vector<double>> EPy, vector<vector<double>> EStable);
    void ElementFormRhsVecb1(bool flag_glb, const vector<int> &IEN, vector<vector<double>> EM, vector<vector<double>> EK, vector<vector<double>> EConv, vector<vector<double>> EPx, vector<vector<double>> EPy, vector<vector<double>> EStable, vector<double> Evec_desire);
    void ElementFormRhsVecb2(bool flag_glb, const vector<int> &IEN, vector<vector<double>> EM, vector<vector<double>> EK, vector<vector<double>> EConv, vector<vector<double>> EPx, vector<vector<double>> EPy, vector<vector<double>> EStable, vector<double> Evec_desire);
    void ElementFormRhsVecb3(bool flag_glb, const vector<int> &IEN, vector<vector<double>> EM, vector<vector<double>> EK, vector<vector<double>> EConv, vector<vector<double>> EPx, vector<vector<double>> EPy, vector<vector<double>> EStable, vector<double> Evec_desire);
    ...
    void FormGlobalMatrix(Mat M, Mat K, Mat P[dim], Mat &A);
